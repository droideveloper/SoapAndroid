 ...
 * as org.fs.xml.soap.reader.text.CollectionTextXMLParser
 */
public final class CollectionTextXMLParser implements TextXMLWriter<XmlSerializer, Collection<?>>, TextXMLReader<XmlPullParser, Collection<?>>{
